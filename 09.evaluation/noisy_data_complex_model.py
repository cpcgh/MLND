...
def plot_curve():
    ...
    # train_sizes, train_scores, test_scores = learning_curve(reg, X, y, cv=cv, n_jobs=1, scoring=score)
    train_sizes, train_scores, test_scores = learning_curve(reg, X, y, cv=cv, n_jobs=1, scoring=score, train_sizes = np.linspace(0.1, 1.0, 10))
